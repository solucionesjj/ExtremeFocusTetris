...
Everything under `core/error`/`core/utils`, and the rest of each feature's folder structure beyond what Settings/Statistics/Game needed so far, doesn't exist yet — created when its roadmap phase needs it. Next up: **Phase 8** (Accesibilidad).
