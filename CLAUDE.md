...
- The Classic "combo x N" popup and Focus Mode's border glow (spec.md 9.2) are deliberately **not implemented yet** — they're animated/particle effects that belong to Phase 7's explicit scope. Only a persistent "Combo x{n}" text indicator exists today. Don't assume this was an oversight.
